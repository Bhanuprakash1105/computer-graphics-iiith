...
function generateQuestionContainer(QID, AID, status) {
    ...
    parentDiv.style = "padding:1em 1em 1em 1em";
    ...
    for (var i = 0; i < 3; i++) {
        ...
        OptionDiv.style = "padding:10px 0px 0px 0px";
...
function putResult() {
    ...
    for (var i = 0; i < TotalContainer; i++) {
        ...
        if (UserAnswers[i] === -1) {
            document.getElementById(UserAnsID).innerHTML = "<br>"+"Question Skipped";
            ...
            if (t1 !== t2) {
                ResultStatus = "<br>"+"Your Answer is Incorrect : ";
                document.getElementById(UserAnsID).style = "background-color:white";
                document.getElementById(UserAnsID).style.color = "red";
            } else {
                ResultStatus = "<br>"+"Your Answer is Correct : ";
                document.getElementById(UserAnsID).style = "background-color:white";
...
function startQuiz() {
    ...
    document.getElementById("TaskTitle").innerHTML = " Quiz : Hierachical Transformations: 3D Articulated Arm - Virtual Labs";
...
function submitQuiz() {
    ...
    document.getElementById("result").innerHTML = "Total score obtained is "+(CorrectCount).toString() + " out of " + TotalContainer;
    putResult();
